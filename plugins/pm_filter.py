...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ', url='https://t.me/Unni0240')
        ], [
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/Masterrockiei/Giyu'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Unni4020')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
